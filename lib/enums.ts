...
export const VALID_ETAPA          = ['Idea', 'Perfil', 'Prefactibilidad', 'Factibilidad', 'Preinversión', 'Diseño', 'Ejecución', 'Operación', 'Terminado'] as const

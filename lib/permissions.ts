...
export const FUNCTIONS = [
  ...
  { key: 'comite.infraestructura.operar', label: 'Operar Comité de Nudos Críticos', group: 'Comités' },
  { key: 'comite.infraestructura.cerrar', label: 'Cerrar sesión de Nudos Críticos', group: 'Comités' },
  { key: 'comite.infraestructura.configurar', label: 'Configurar Comité de Nudos Críticos', group: 'Comités' },
